...
struct file_operations {
    uint64_t (*read)(uint64_t port, uint64_t size, uint64_t skip,
                     uint8_t *buffer);
    uint64_t (*write)(uint64_t port, uint64_t size, uint64_t skip,
                      uint8_t *buffer);
...
uint64_t device_read(const char *name, uint64_t size, uint64_t offset,
                     uint8_t *buffer);
