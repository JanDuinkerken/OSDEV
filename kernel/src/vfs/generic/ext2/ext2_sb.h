...
#define EXT2_INDIRECT_BLOCKS(blocksize, sizeo_of_entry)                        \
    ((blocksize / sizeo_of_entry))
#define EXT2_DOUBLE_INDIRECT_BLOCKS(blocksize, sizeo_of_entry)                 \
    ((blocksize / sizeo_of_entry) * (blocksize / sizeo_of_entry))
#define EXT2_TRIPLE_INDIRECT_BLOCKS(blocksize, sizeo_of_entry)                 \
    ((blocksize / sizeo_of_entry) * (blocksize / sizeo_of_entry) *             \
     (blocksize / sizeo_of_entry))
