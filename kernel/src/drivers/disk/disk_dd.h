...
struct sata_ident_test {
    ...
    uint16_t block_align;    /* Alignement of logical blocks in larger physical
                                blocks */
    ...
    uint16_t min_dwnload_blocks; /* Minimum number of 512byte units per DOWNLOAD
                              MICROCODE command for mode 03h */
    uint16_t max_dwnload_blocks; /* Maximum number of 512byte units per DOWNLOAD
                              MICROCODE command for mode 03h */
...
struct sata_ident {
    ...
    uint16_t
        PhysicalLogicalSectorSize_MultipleLogicalSectorsPerPhysicalSector : 1;
