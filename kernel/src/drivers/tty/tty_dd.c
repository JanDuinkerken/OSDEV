...
uint64_t tty_dd_read_block_direct(struct tty *dev, uint64_t size, uint64_t skip,
                                  uint8_t *buffer) {
...
uint64_t tty_dd_write_block_direct(struct tty *dev, uint64_t size,
                                   uint64_t skip, uint8_t *buffer) {
    buffer += skip;
    if ((uint64_t)(int)size != size) {
...
uint64_t tty_dd_read_block(uint64_t port, uint64_t size, uint64_t skip,
                           uint8_t *buffer) {
...
uint64_t tty_dd_write_block(uint64_t port, uint64_t size, uint64_t skip,
                            uint8_t *buffer) {
...
struct file_operations tty_fops = {.read = tty_dd_read_block,
