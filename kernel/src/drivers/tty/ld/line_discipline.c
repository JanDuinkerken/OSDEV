...
struct line_discipline_action_table_entry default_ld_table[] = {
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 0
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 1 A
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 2 B
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_sigint}, // 3 C
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_eof}, // 4 D
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 5 E
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 6 F
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_bell}, // 7 G
    ...
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     ...
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_htab}, // 9 I
    {.output = {'\n', LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {'\r', '\n', LD_NULL, LD_NULL},
     .action = ld_lfeed}, // 10 J
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_vtab}, // 11 K
    ...
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 14 N
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 15 O
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 16 P
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_restart_out}, // 17 Q
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 18 R
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_stop_out}, // 19 S
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 20 T
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 21 U
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 22 V
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 23 W
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 24 X
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_ignore}, // 25 Y
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_sigstop}, // 26 Z
    {.output = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserti = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .inserto = {LD_NULL, LD_NULL, LD_NULL, LD_NULL},
     .action = ld_del}, // 27
...
line_discipline_create(int mode, int echo, int table, int buffer_size,
    ...
    struct line_discipline *ld =
        (struct line_discipline *)malloc(sizeof(struct line_discipline));
    if (ld == 0)
        return 0;

    if (mode == LINE_DISCIPLINE_MODE_RAW ||
        mode == LINE_DISCIPLINE_MODE_CANONICAL)
        ld->mode = mode;
    else
        ld->mode = LINE_DISCIPLINE_MODE_CANONICAL;

    if (echo == LINE_DISCIPLINE_MODE_ECHO_ON ||
        echo == LINE_DISCIPLINE_MODE_ECHO_OFF)
        ld->echo = echo;
    else
        ld->echo = LINE_DISCIPLINE_MODE_ECHO_ON;
...
void line_discipline_apply(struct line_discipline *ld, char c) {
    ...
    if (ld->echo == LINE_DISCIPLINE_MODE_ECHO_ON && ld->echo_cb != 0) {
        for (int i = 0; i < LD_OUTPUT_SIZE; i++) {
            if (ld->action_table[(uint8_t)c].output[i] == LD_NULL)
                break;
...
int line_discipline_translate(struct line_discipline *ld,
    ...
    if (ld->mode == LINE_DISCIPLINE_MODE_RAW) {
        ...
        if (original_character != LD_DEL &&
            (original_character < 0 || original_character > 27))
            goto same;

        int i = 0;
        for (i = 0; i < LD_OUTPUT_SIZE; i++) {
            if (ld->action_table[(uint8_t)original_character].inserto[i] ==
                LD_NULL)
                break;
            translated_characters[i] =
                ld->action_table[(uint8_t)original_character].inserto[i];
        }
        return i;
    }
